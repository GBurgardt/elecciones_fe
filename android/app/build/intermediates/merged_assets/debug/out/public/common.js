...
/* harmony import */ var _models_resultado_model__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../models/resultado.model */ "./src/app/models/resultado.model.ts");
...
var AuthService = /** @class */ (function () {
    function AuthService(http) {
         ...
         */
        this.getCategoriasByMesaAndPuntoMuestral = function (idPuntoMuestral, mesa) { return _this.http.get(
        // `${environment.WS_URL}/categoria`
        src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].WS_URL + "/punto_muestral/" + idPuntoMuestral + "/mesas/" + mesa.id + "/categorias"); };
        /**
         * Retorna un Observable con todas las mesas de un punto muestral dado
         */
        this.getMesasByPuntoMuestral = function (idPuntoMuestral) { return _this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].WS_URL + "/punto_muestral/" + idPuntoMuestral + "/mesas"); };
        /**
         * Retorna un Observable el puntoMuestral dado un celular
         */
        this.getPuntoMuestralByCelular = function (celular) { return _this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].WS_URL + "/punto_muestral/" + celular); };
        /**
         * Retorna un Observable los candidatos dada una categoria
         */
        this.getCandidatosByCategoria = function (idCategoria) { return _this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].WS_URL + "/categoria/" + idCategoria + "/candidatos"); };
        /**
         * Inseta en la db todos los nuevos mesasCandidatos
         */
        this.postMesasCandidatos = function (mesasCandidatos, imgBlob, mesa, categoria) {
            var formData = new FormData();
            formData.append('attachment', imgBlob);
            formData.append('mesasCandidatos', JSON.stringify(mesasCandidatos));
            return _this.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].WS_URL + "/mesa-candidato/" + mesa.descripcion + "/" + categoria.descripcion, formData);
        };
        /**
         * Retorna un Observable con los resultados
         */
        this.getResultados = function (idCategoria, idMesa) { return _this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].WS_URL + "/resultados/" + idCategoria + "/" + idMesa).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (resp) { return resp.map(function (a) { return new _models_resultado_model__WEBPACK_IMPORTED_MODULE_5__["Resultado"](a); }); })); };
        /**
         * Retorna TODAS las categorias en un Observable
         */
        this.getAllCategorias = function () { return _this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].WS_URL + "/categorias"); };
        /**
         * Retorna TODAS las mesas en un Observable
         */
        this.getAllMesas = function () { return _this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].WS_URL + "/mesas"); };
        /**
         * Reportar presencia
         */
        this.setRegistroIngreso = function (celular, newRegistroIngreso) { return _this.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].WS_URL + "/punto_muestral/" + celular, {
