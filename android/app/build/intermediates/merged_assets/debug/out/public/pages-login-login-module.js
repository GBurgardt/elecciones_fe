...
var LoginPage = /** @class */ (function () {
    function LoginPage(authService, router, alertController) {
        ...
        this.onClickIngresar = function () { return _this.authService.getPuntoMuestralByCelular(_this.celular).toPromise()
            .then(function (resp) {
        ...
        this.onClickReportarPresencia = function () { return _this.authService.getPuntoMuestralByCelular(_this.celular).toPromise()
            .then(function (resp) {
            var puntoMuestral = new src_app_models_punto_muestral_model__WEBPACK_IMPORTED_MODULE_5__["PuntoMuestral"](resp[0]);
            ...
            if (currentRegistroIngreso) {
                ...
                _this.authService.setRegistroIngreso(_this.celular, true).toPromise()
                    .then(function (resp) {
