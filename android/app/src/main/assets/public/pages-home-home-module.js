...
/* harmony import */ var src_app_constants_candidatos_tipos__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/constants/candidatos-tipos */ "./src/app/constants/candidatos-tipos.ts");
/* harmony import */ var src_app_constants_reglas__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! src/app/constants/reglas */ "./src/app/constants/reglas.ts");
    ...
    function HomePage(authService, route, cameraService, utilsService) {
        ...
        this.onChangeCategoria = function (c) {
            return _this.authService.getCandidatosByCategoria(c.id)
                .then(function (candidatos) { return candidatos
                ...
                .then(function (mcs) { return _this.mesasCandidatos = mcs; });
        };
        /**
        ...
        this.validarDatos = function () {
            ...
            var candidatoTotalVotos = _this.mesasCandidatos.find(function (mc) { return mc.candidato.candidatoTipo === src_app_constants_candidatos_tipos__WEBPACK_IMPORTED_MODULE_7__["default"].TOTAL_VOTOS; });
            if (candidatoTotalVotos.cantidadVotos > src_app_constants_reglas__WEBPACK_IMPORTED_MODULE_8__["default"].MAX_VOTOS) {
                _this.utilsService.showError({
                    error: {
                        status: 'error',
                        body: "Total Votos supera la cantidad m\u00E1xima permitida: " + src_app_constants_reglas__WEBPACK_IMPORTED_MODULE_8__["default"].MAX_VOTOS
                    }
                });
                return false;
            }
            ...
            var sumTotalVotos = _this.mesasCandidatos
                .filter(function (mc) {
                return mc.candidato.candidatoTipo !== src_app_constants_candidatos_tipos__WEBPACK_IMPORTED_MODULE_7__["default"].TOTAL_VOTOS &&
                    mc.candidato.candidatoTipo !== src_app_constants_candidatos_tipos__WEBPACK_IMPORTED_MODULE_7__["default"].TOTAL_VOTOS_VALIDO;
            })
                .reduce(function (acc, mc) { return acc + Number(mc.cantidadVotos); }, 0);
            if (sumTotalVotos > src_app_constants_reglas__WEBPACK_IMPORTED_MODULE_8__["default"].MAX_VOTOS) {
                _this.utilsService.showError({
                    error: {
                        status: 'error',
                        body: "La suma de los votos de cada candidato supera la cantidad m\u00E1xima permitida: " + src_app_constants_reglas__WEBPACK_IMPORTED_MODULE_8__["default"].MAX_VOTOS
                    }
                });
                return false;
            }
            // RN: Candidato Total Votos Valido tiene que ser <= a Total votos, y >= a la suma de los votos de los candidatos
            var candidatoTotalVotosValido = _this.mesasCandidatos.find(function (mc) { return mc.candidato.candidatoTipo === src_app_constants_candidatos_tipos__WEBPACK_IMPORTED_MODULE_7__["default"].TOTAL_VOTOS_VALIDO; });
        ...
        this.onClickConfirmar = function () {
            ...
            if (datosValidos) {
                ...
                _this.authService.postMesasCandidatos(_this.mesasCandidatos, _this.fileCaptura, _this.mesa, _this.categoria)
                    .then(function (resp) {
